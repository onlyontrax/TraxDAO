...
} & ComponentPropsWithoutRef<typeof SidebarItem> &
  Omit<Headless.MenuButtonProps<typeof Button>, 'as' | 'className'>

type MenuButtonType = (typeof Headless.MenuButton) & {
  displayName?: string
}
...
export const DropdownButton = forwardRef(function DropdownButton(
  { className, children, ...props }: DropdownButtonProps,
  forwardedRef: ForwardedRef<HTMLButtonElement | HTMLAnchorElement>
) {
  const MenuButton = Headless.MenuButton as MenuButtonType
  ...
  return (
    <Headless.MenuItems
      ...
      className={clsx(
        ...
        'outline outline-1 outline-slaps-gray',
        // Handle scrolling when menu won't fit in viewport
        'overflow-y-auto',
        // Popover background
        'bg-white/75 backdrop-blur-xl dark:bg-zinc-800/75',
        // Shadows
        'shadow-lg ring-zinc-950/10 dark:ring-inset dark:ring-white/10',

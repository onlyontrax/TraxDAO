...
const colors = {
  ...
  lime: 'bg-trax-lime-400/20 text-trax-lime-700 group-data-[hover]:bg-trax-lime-400/30 dark:bg-trax-lime-400/10 dark:text-trax-lime-300 dark:group-data-[hover]:bg-trax-lime-400/15',
  green:
    'bg-trax-green-500/15 text-trax-green-700 group-data-[hover]:bg-trax-green-500/25 dark:bg-trax-green-500/10 dark:text-trax-green-400 dark:group-data-[hover]:bg-trax-green-500/20',
  emerald:
  ...
  pink: 'bg-trax-pink-400/15 text-trax-pink-700 group-data-[hover]:bg-trax-pink-400/25 dark:bg-trax-pink-400/10 dark:text-trax-pink-400 dark:group-data-[hover]:bg-trax-pink-400/20',

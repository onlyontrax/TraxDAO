                ...
                <div className="nav-bar">
                  <ul className='nav-icons' style={{justifyContent: user._id ? 'space-between' : 'space-around'}}>
                    <li className={router.pathname === '/home' ? 'active' : ''}>
                      <Link href="/home">
                      <AiOutlineHome style={{fontSize: '28px', position: 'relative', top: '4px', marginTop: '-4px', left: '1px'}} className={router.pathname === '/home' ? 'active-icon' : ''}/>
                    ...
                    <li className={router.pathname === '/' ? 'active' : ''}>
                      <Link href="/">
                      <FontAwesomeIcon style={{fontSize: '24px', position: 'relative', top: '2px', marginBottom: '1px'}} icon={faCompass} className={router.pathname === '/' ? 'active-icon' : ''}/>
                    ...
                    {user._id && (user?.isPerformer && (
                      <li className={router.pathname === '/artist/my-post/create' ? 'active' : ''}>
                        ...
                        <FontAwesomeIcon style={{fontSize: '25px', position: 'relative', top: '2px', marginTop: '0px', left: '-1px'}} icon={faSquarePlus} className={router.pathname === '/artist/my-post/create' ? 'active-icon' : ''}/>
                    ...
                    <li key="artist" className={router.pathname === '/artist' ? 'active' : ''}>
                      <Link href="/artist">
                        <FontAwesomeIcon style={{fontSize: '24px', position: 'relative', top: '1px', marginTop: '0px', left: '-2px'}} icon={faMagnifyingGlass} className={router.pathname === '/artist' ? 'active-icon' : ''} />
                    ...
                    <li key="messenger" className={router.pathname === '/messages' ? 'active' : ''}>
                      <Link href="/messages">
                      <FontAwesomeIcon style={{fontSize: '24px', position: 'relative', top: '4px', marginTop: '-4px', marginBottom: '5px', left: '-2px'}} icon={faComment} className={router.pathname === '/messages' ? 'active-icon' : ''}/>
                        <Badge
                    ...
                    <li key="avatar" aria-hidden onClick={() => this.setState({ openProfile: true })} style={{display: 'flex', flexDirection: 'column'}}>
                      <FontAwesomeIcon style={{fontSize: '24px', position: 'relative', top: '4px', marginTop: '-4px', marginBottom: '5px', left: '-1px', color: 'grey'}} icon={faBars} />

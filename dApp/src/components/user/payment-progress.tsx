...
const PaymentProgress = ({progress, performer}): JSX.Element => {
            ...
            <div className="left-col">
              ...
              <div className="p-name" style={{fontWeight: '300'}}>
                ...
                {performer?.verifiedAccount && (
                  <BadgeCheckIcon style={{ height: "1.2rem", top: '4px', position: 'relative' }} className="primary-color" />
                )}
              </div>
              <span style={{color: 'white', fontSize: '13px', fontWeight: '300'}}>Please do not refresh the page.</span>
            </div>
